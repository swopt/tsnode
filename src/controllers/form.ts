...
export let getLayout = (req: Request, res: Response) => {
    let layout: any = {
                ...
                "fields" : [
                    {
                        ...
                        "events" : [{
                            "event" : "click",
                            "actions" : [{ "action" : "switch_status", "status" : "adding"}]
                        }]
                    },
                    {	
                        "type" : "grp_page",
